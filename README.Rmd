...
Some of the medians were calculated by averaging values for 2 different stations, so I had to search for multiple stations and couldn't use simple indexing.
